...
function setElementWrapper(element) {
...
function printSelectedMonth() {
	getSelectedMonth();
	content =  printMonth(currentMonth, currentYear);
...
function printMonth(mm, yy) {
	var res = "<div id='table_calendar_wrapper'>";
...
function getPrevMonthLink(mm, yy) {
	...
	return '<span class="change-time" onclick="regenerateCalendar('+mm1+','+yy1+')" >&lt;</span>';
}
...
function getPrevYearLink(mm, yy) {
	...
	return '<span class="change-time" onclick="regenerateCalendar('+mm+','+(yy-1)+')" >&lt;&lt;</span>';
}
...
function printCell(lunarDate, solarDate, solarMonth, solarYear) {
	...
	if (lunarDate != null) res += (' title="'+getDayName(lunarDate)+'" day="'+lunarDate.day+'" month="'+lunarDate.month+'" year="'+lunarDate.year+'" leap="'+lunarDate.leap+'" jd="'+lunarDate.jd+'" solardate="'+solarDate+'" solarmonth="'+solarMonth+'" solaryear="'+solarYear+'" >');
